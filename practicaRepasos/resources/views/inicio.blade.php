...
<h1 style="text-align: center;">Bienvenido a mi pagina web</h1>
<h4 style="text-align: center;">Universidad Politecnica de Queretaro</h1>
<img src="{{asset('img/UPQL.png')}}" style="display: block; margin: 0 auto;">
<p style="text-align: center;">Repaso 1</p>
